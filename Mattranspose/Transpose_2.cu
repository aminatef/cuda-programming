...
__global__ void transposeCoalesced_noBank_conflicts(float * out,float* in,const int nx,int ny){
...
int main(){
    ...
    transposeCoalesced_noBank_conflicts<<<grid,block>>>(d_C,d_A,nx,ny);
